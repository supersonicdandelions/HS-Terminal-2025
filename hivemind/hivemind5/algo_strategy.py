...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def starter_strategy(self, game_state):
        ...
        if True: #game_state.turn_number % 2 == 1:
            ...
            if game_state.project_future_MP(1,0)>=21:
            ...
            if blocked:
                leastDamage*=2
            if go and game_state.get_resource(MP)>=21: #blocked:
                game_state.attempt_spawn(SCOUT, [14,0],5)
                game_state.attempt_spawn(SCOUT, [2,11],5)
    ...
    def build_defences(self, game_state):
        ...
        game_state.attempt_spawn(SUPPORT, [13,12])
